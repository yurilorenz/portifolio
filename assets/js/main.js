...
document.querySelector(".bootstrap").addEventListener("mouseover", function () {
  texto1.innerHTML =
    "Bootstrap é o mais popular framework CSS para desenvolvimento de projetos responsivos e focados para dispositivos móveis na web. <br><br> 1 mês de experiência";
});
...
document.querySelector(".node").addEventListener("mouseover", function () {
  texto1.innerHTML =
    "Node.js é um software de código aberto, multiplataforma, e que permite a execução de códigos JavaScript fora de um navegador web. <br><br> 3 meses de experiência";
});
